...
//                     <span onClick={() => { setDeleteModal({ id: list.id, name: `${list.first_name} ${list.last_name}` }) }}>Delete</span>
//                 </div> : <div className={style.dropdownContent}>
//                     <Link to={`/staff/${list.id}`}>View</Link>
//                 </div>}
//         </div>
//     }, [onEdit, appState.userType]);
...
//                                         dispatch({
//                                             type: 'TOAST_MESSAGE',
//                                             successMessage: `Passwort has been changed`,
//                                             errorMessage: null
//                                         });
//                                         setValidations({
//                                             passwordLengthVal: false,
